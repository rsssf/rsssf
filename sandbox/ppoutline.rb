...
ROUND_RE = %r{\A
        [ ]*
         (?<text>
             ...
             ### todo/fix - move to GROUP_RE 
             ##          why? why not?

             (?:
                (?:   ## allow optional qualifier - why? why not?
                     (?: Europe |
                         South [ ] America |
                 ...
                 (?:  [A-Z]   |         ## e.g  group a, group b,
                  ...
                  (?:   ## allow optional winner or qualified team in brackets
                        ## e.g. [West Germany]
                     [ ]*
                     \[[^]]+ (\]|$)   ## eg. [Brazil  -- better fix in 70q.txt!!
                  )?
             )  |  
                                             
             
             
             Playoff:?   |      # used inside Group B etc. really Group B Playoff
